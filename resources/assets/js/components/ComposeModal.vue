			...
			<div class="card status-card card-md-rounded-0 w-100 h-100" style="display:flex;">
				...
				<div class="card-body p-0 border-top">
								...
								<div class="media-body">
									<div class="form-group">
										...
										<p class="mb-0 mt-2">
											...
											<a v-if="config.nsfw.enabled" class="btn rounded-pill mx-3 d-inline-flex align-items-center" href="#" :class="[nsfw ? 'btn-danger' : 'btn-outline-lighter']" style="height: 37px;" @click.prevent="nsfw = !nsfw" title="Mark as sensitive/not safe for work">
					...
					<div v-else-if="page == 3" class="w-100 h-100">
						...
						<div v-if="config.nsfw.enabled" class="border-bottom px-4 mb-0 py-2">
							<div class="d-flex justify-content-between">
								<div>
					...
					<div v-else-if="page == 'video-2'" class="w-100 h-100">
						...
						<div v-if="config.nsfw.enabled" class="border-bottom d-flex justify-content-between px-4 mb-0 py-2 ">
							<div>
